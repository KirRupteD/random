...
std::random_device Jewel;
std::mt19937 randomEngine(Jewel());
std::uniform_int_distribution<>range1(0,1200);
std::uniform_int_distribution<>range2(0,970);

for(int i=1;i<+20;i++){
	X.push_back(range1(randomEngine));
	Y.push_back(range2(randomEngine));
}
}
